...
var Data = [{
  ...
  details: 'Donnie-Bank  is a app that lets customers to login to thier bank account and see the all the transactions, request a loan or transfer money to frined who uses same bank.',
  ...
  details: 'Random Dice game lets two people to play. Player rolls the dice until gets to 20 points. If player hit number 1 looses all the accumelated points. Player has option of holding current points and pass the turn other player.',
...
var ModalWindow = function ModalWindow(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: "modal-wrap flex visible",
    ...
    return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
      ...
      id: "carousel",
      style: {
        width: '-700px; transform: translateX(0px)'
      },
      className: true
    ...
    }, details), /*#__PURE__*/_react["default"].createElement("a", {
      href: link,
      target: "_blank"
    }, /*#__PURE__*/_react["default"].createElement("div", {
    ...
    }), "VIEW SITE"))), /*#__PURE__*/_react["default"].createElement("i", {
...
var _ReposGallery = _interopRequireDefault(require("./ReposGallery"));

var _ReposMenu = _interopRequireDefault(require("./ReposMenu"));
...
var ReposComponent = function ReposComponent() {
  ...
  var filterModal = function filterModal(repo) {
    var updateModal = _data["default"].filter(function (element) {
  ...
  var filterItem = function filterItem(el) {
    var updateItems = _data["default"].filter(function (curEl) {
  ...
  var confirmModal = function confirmModal(event) {
    setIsOpen(event);
  };

  return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, isOpen && /*#__PURE__*/_react["default"].createElement(_ModalWindow["default"], {
    dataModal: modalData,
    closeModal: confirmModal,
    key: "modal-key"
  }), /*#__PURE__*/_react["default"].createElement(_ReposMenu["default"], {
    filterItem: filterItem
  }), /*#__PURE__*/_react["default"].createElement(_ReposGallery["default"], {
    key: "unique-key",
    item: items,
...
var ReposGallery = function ReposGallery(_ref) {
  var item = _ref.item,
      filterModal = _ref.filterModal,
      modalOpen = _ref.modalOpen;

  var addModal = function addModal(e) {
    var eventClass = e.target.className.slice(-2).trim();
    modalOpen(true);
    console.log(eventClass); // console.log(eventClass.length);
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    while (i < 6) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "highlight"
      }, highlights)), /*#__PURE__*/_react["default"].createElement("button", {
        className: "btn-learn-more ".concat(id),
        onClick: addModal
      }, "LEARN MORE")));
    }
  }));
...
var Menu = function Menu(_ref) {
  var filterItem = _ref.filterItem;
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: "btn ".concat(isValid === 'JAVASCRIPT' ? 'btn-active' : ''),
    onClick: function onClick() {
      return toggleClass('JAVASCRIPT');
    }
  }, "JAVASCRIPT"), /*#__PURE__*/_react["default"].createElement("button", {
    className: "btn ".concat(isValid === 'CSS-SASS' ? 'btn-active' : ''),
    onClick: function onClick() {
      return toggleClass('CSS-SASS');
    }
  }, "CSS-SASS"), /*#__PURE__*/_react["default"].createElement("button", {
    className: "btn ".concat(isValid === 'REACT' ? 'btn-active' : ''),
    onClick: function onClick() {
      return toggleClass('REACT');
    }
  }, "REACT"), /*#__PURE__*/_react["default"].createElement("button", {
    className: "btn ".concat(isValid === 'PYTHON' ? 'btn-active' : ''),
    onClick: function onClick() {
      return toggleClass('PYTHON');
    }
  }, "PYTHON"), /*#__PURE__*/_react["default"].createElement("button", {
    className: "btn ".concat(isValid === 'MERN' ? 'btn-active' : ''),
    onClick: function onClick() {
      return toggleClass('MERN');
    }
  }, "MERN")));
};
...
>>>>>>> 2c58928a995580b083e3b7e66dc598054d0670aa
